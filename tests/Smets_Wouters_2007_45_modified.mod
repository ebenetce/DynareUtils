...
mode_compute=0,mode_file='C:\Users\LEJEUTH\Onedrive - National Bank of Belgium\Documents\MATLAB\mod\fmincon_parallel_tests\Smets_Wouters_2007_45_modified\Output\Smets_Wouters_2007_45_modified_mode.mat',
first_obs=1, presample=4,lik_init=2,prefilter=0,
mh_replic=5000,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2, nograph, nodiagnostic, tex);